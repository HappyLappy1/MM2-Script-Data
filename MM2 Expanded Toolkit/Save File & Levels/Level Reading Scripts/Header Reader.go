...
func test_roundtrip() error {
	...
	// Name the course you want to read here (In this case, "course_data_001.bcd")
	buf, err := ioutil.ReadFile("course_data_005.bcd")
	if err != nil {
		return err
	}
	...
	err = ioutil.WriteFile("course_data_00N.bcd", out, 0600)
	if err != nil {
		return err
	}
