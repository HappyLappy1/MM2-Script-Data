...
func main() {
  // Select the bcd file you wish to edit (in this case, "course_data_005.bcd")
  rawBCD, err := ioutil.ReadFile("course_data_005.bcd")
  if err != nil {
    log.Fatal(err)
  }
  ...
  // Name new output file "course_data_005.bcd" (replacing the old one. Will make a new file if name doesn't exist)
    err = ioutil.WriteFile("course_data_005.bcd", newBCD, 0600)
  if err != nil {
    log.Fatal(err)
  }
}